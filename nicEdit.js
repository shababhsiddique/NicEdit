...
var nicEditorPane = bkClass.extend({
    ...
    position: function () {
        if (this.ne.nicPanel) {
            ...
            var newLeft = '0px';//panelPos[0] + parseInt(panelElm.getStyle('width'), 10) - (parseInt(this.pane.getStyle('width'), 10) + 8);//Change here for fixign missing color Shabab
